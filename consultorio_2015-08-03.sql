...
# Tiempo de Generación: 2015-08-04 00:19:21 +0000
# ************************************************************
...
INSERT INTO `cargo` (`id`, `Nombre`, `Permisos`)
VALUES
	(2,'Medico','{\"admin\":true,\"citas\":true,\"consultas\":true,\"pacientes\":true}');
...
INSERT INTO `cita` (`id`, `Paciente`, `Horario`, `Fecha`, `Observacion`, `Atendido`)
VALUES
	(5,3,'M','2015-08-05','Necesitamos Ver que Tiene','SI'),
	(6,3,'M','2015-08-05','Otra Cita Por su dolor de cara','NO');
...
INSERT INTO `consulta` (`id`, `Paciente`, `Sintomas`, `Diagnostico`, `Tratamiento`, `Receta`, `Observacion`, `Medico`, `Fecha`)
VALUES
	(3,3,'No Tenia','Nada','De ','Nada','En Nada',2,'2015-08-03 18:51:04');
...
INSERT INTO `departamento` (`idDepa`, `departamento`)
VALUES
	(1,'AMAZONAS'),
	(2,'ANCASH'),
	(3,'APURIMAC'),
...
INSERT INTO `distrito` (`idDist`, `distrito`, `idProv`)
VALUES
	(1,'CHACHAPOYAS',1),
	(2,'ASUNCION',1),
	(3,'BALSAS',1),
...
INSERT INTO `paciente` (`id`, `Documento`, `Telefono`, `Nombre`, `Edad`, `Sexo`, `Email`, `Departamento`, `Municipio`, `Direccion`, `Activo`)
VALUES
	(3,'72222464','971622573','Manuel Aguinaga Perez',20,'M','maninux_12@hotmail.com',14,1213,'los jardines','SI');
...
INSERT INTO `provincia` (`idProv`, `provincia`, `idDepa`)
VALUES
	(1,'CHACHAPOYAS ',1),
	(2,'BAGUA',1),
	(3,'BONGARA',1),
...
INSERT INTO `usuario` (`id`, `Documento`, `NombreCompleto`, `Contrasena`, `Consultorio`, `Cargo`, `Activo`)
VALUES
	(2,'48342427','Adrian Ruiz Figueroa','94a19016b9262a98bebf4c7b2150d480a87873a099c5b57f30bc775479d668c7',8,2,'SI');
