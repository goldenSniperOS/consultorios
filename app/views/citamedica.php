			...
			<div class="col-xs-2 navegador">
				...
				<nav>
					<ul>
						...
						<li><a href="citamedica.php" class="active"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>Citas Médicas</a></li>
			          ...
			          <div class="row">
			            ...
			            <div class="col-md-6">
			            	<div class="form-group">
								...
								<input type="text" class="form-control" id="Fecha" name="Fecha" placeholder="Ingrese su Fecha">
							</div>
			            </div>
			          </div>
			          <div class="row">
					    ...
					    <table class="table table-striped table-bordered">
					        ...
					        <tbody>
					            <tr>
					                ...
					                <td>Medico Jose</td>
					                <td>
					                	<p class="btn btn-success">PROCESADO</p>
					                </td>
					                <td>
				                	<!-- Split button -->
									<div class="btn-group">
